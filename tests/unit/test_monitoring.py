...
from src.cfb_bot.monitoring.performance_metrics import (
    PerformanceMetrics,
    track_performance,
    get_metrics
)
...
class TestSentryIntegration:
    ...
    @patch('src.cfb_bot.monitoring.sentry_integration.sentry_sdk')
    @patch('src.cfb_bot.monitoring.sentry_integration.os.getenv')
    def test_init_sentry_success(self, mock_getenv, mock_sentry):
